               ...
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        ...
                        <select class="form-control select" style="width: 100%;" name="servicos_id">
                           <option value=""> Selecione um serviço </option>
                           <?php

                           foreach ($servicos  as $item) {
                              echo '<option value="' . $item->id . '"><span style="text-transform:uppercase">' . $item->nome . '</span></option>';
                           }
                           ?>
            ...
            <div class="modal-body">
               ...
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="form-group">
                        <label>Serviços</label>
                        <select class="form-control select" style="width: 100%;" name="servicos_id" id="servicos_id">
                           <option value=""> Selecione um serviço </option>
                           <?php
