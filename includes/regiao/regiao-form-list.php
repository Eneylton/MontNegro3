...
foreach ($rotas as $item) {
   ...
   $list .= '<option value="' . $item->id . '">' . $item->descricao . '</option>';
}
...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       ...
                       <a href="regioes-delete.php?id=' . $item->id . '">
...
$resultados = strlen($resultados) ? $resultados : '<tr>
                                                     <td colspan="4" class="text-center" > Nenhuma região encontrada !!!!! </td>
                                                     </tr>';
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog modal-lg">
      <div class="modal-content bg-light">
         <form action="./regioes-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Nova Rota
               </h4>
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  <label>Rotas</label>
                  <select class="form-control select2bs4" style="width: 100%;" name="rotas_id">
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./regioes-edit.php" method="get">
         <div class="modal-content bg-light">
            <div class="modal-header">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  <label>Rotas</label>
                  <select class="form-control select2bs4" style="width: 100%;" name="rotas_id" id="rotas_id">
