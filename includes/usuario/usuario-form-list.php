...
foreach ($cargos as $item) {
   ...
   $list .= '<option style="text-transform:capitalize" value="' . $item->id . '">' . $item->descricao . '</option>';
}
...
foreach ($acessos as $item) {
   ...
   $list2 .= '<option style="text-transform:capitalize" value="' . $item->id . '">' . $item->nivel . '</option>';
}
